...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        "--input_dir",
        # required=True,
        default='/home/datasets/mood/data/abdom/',
        type=str,
    ...
    # parser.add_argument('--input_dir', type=str, default='/Users/zhangzhaoxiang/codes/mood/data/brain/')
    # parser.add_argument('--no_gpu', type=bool, default=True)
    ...
    #         f"--privileged docker:20.10-dind-rootless"
    #     )
    ...
    try:
        docker_str = (
            f"docker run {gpu_str}-v {toy_input_dir}:/mnt/data "
            f"-v {output_dir}:/mnt/pred mood_example sh /workspace/run_pixel_abdom.sh /mnt/data /mnt/pred "
            f"--privileged docker:20.10-dind-rootless"
        )
        ret = subprocess.run(docker_str.split(" "), check=True,)
    except Exception:
